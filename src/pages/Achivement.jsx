    ...
    <div className="min-h-screen flex flex-col bg-gray-50 text-slate-900 dark:bg-[#050507] dark:text-white/92">
      ...
      <main className="flex-grow pt-24 pb-20">
        ...
        <section className="relative w-full py-20 lg:py-24 overflow-hidden border-b border-slate-200/70 dark:border-white/10">
          ...
          <div className="mx-auto px-6 sm:px-12 relative z-10 flex flex-col md:flex-row items-center justify-center gap-12 text-center md:text-left">
            <motion.div
            ...
            >
              <img
                ...
                className="w-58 md:w-64 h-auto rounded-xl  shadow-[0_20px_50px_rgba(148,163,184,0.3)] dark:shadow-[0_0px_55px_rgba(255,255,255,0.2)] border-4 border-slate-200 dark:border-white/10"
              />
            </motion.div>
