    ...
    <div className="pointer-events-none absolute inset-0 overflow-hidden">
      {stars.map((star) => (
        <motion.div
          ...
          className="absolute rounded-full bg-amber-500/40 dark:bg-white"
          style={{
            left: star.left,
            top: star.top,
            width: star.size,
      ...
      <div className="grid flex-1 items-center gap-10 lg:grid-cols-[1fr_1.05fr_0.95fr] lg:gap-8 z-10 relative">
        ...
        >
          ...
          <div className="space-y-2">
            <h1 className="text-[clamp(3.3rem,7vw,6.2rem)] font-bold leading-[0.92] tracking-[-0.04em] text-neutral-950 dark:text-white space-x-px">
              Vorng
            </h1>
            <h2 className="text-[clamp(2.8rem,5.8vw,4.9rem)] font-semibold leading-[0.95] tracking-[-0.04em] text-slate-800 dark:text-white/96">
              Sovannreach
            </h2>
          </div>
        ...
        >
          <img
            ...
            className="rounded-[50%] w-full max-w-[400px] object-cover shadow-[0_20px_50px_rgba(148,163,184,0.3)] dark:shadow-[0_0px_55px_rgba(255,255,255,0.25)] border-4 border-white dark:border-transparent transition-all duration-300"
          />
        </motion.div>
        ...
        >
          <p className="max-w-[28rem] text-[1.15rem] leading-[1.6] text-slate-600 dark:text-white/92 sm:text-[1.25rem]">
